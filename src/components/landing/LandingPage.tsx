...
import {
  ...
  ArrowRight, Check, Sparkles, Zap, Shield, Users, Brain, Clock, Target, Award
} from "lucide-react";
...
const capabilities = [
  {
    icon: MessageSquare,
    title: "Chat con IA",
    desc: "Conversaciones inteligentes con múltiples modelos de lenguaje para resolver cualquier desafío.",
...
const steps = [
  {
    num: "01",
    title: "Escribe o carga",
    desc: "Describe lo que necesitas o sube tus archivos. La IA entiende tu contexto.",
  },
  {
    num: "02",
    title: "La IA transforma",
    desc: "Procesamos tu solicitud con los mejores modelos de IA del mercado.",
  },
  {
    num: "03",
    title: "Exporta y ejecuta",
    desc: "Obtén resultados listos para usar: documentos, código, presentaciones y más.",
  },
];
...
const plans = [
  {
    ...
    price: "$0",
    period: "/mes",
    features: ["5 chats/día", "1 documento/semana", "Modelos básicos", "Búsqueda limitada"],
    cta: "Comenzar gratis",
    featured: false,
  },
  {
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    features: ["Todo en Pro", "API dedicada", "SSO / SAML", "SLA 99.9%", "Soporte 24/7", "On-premise disponible", "Capacitación incluida"],
...
const metrics = [
  ...
  { value: "4.8/5", label: "Satisfacción", icon: Award },
];

const benefits = [
  { icon: Clock, title: "Ahorra tiempo", desc: "Automatiza tareas repetitivas y enfócate en lo que importa" },
  { icon: Target, title: "Resultados precisos", desc: "IA entrenada para generar contenido de alta calidad" },
  { icon: Zap, title: "Respuestas instantáneas", desc: "Obtén resultados en segundos, no en horas" },
];
      ...
      <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto flex items-center justify-between h-16 px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" className="btn-primary-gradient px-4" onClick={handleStart}>
              Comenzar
            </Button>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <motion.div custom={3} variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" className="btn-primary-gradient px-8 py-3 text-base" onClick={handleStart}>
            ...
            <motion.p custom={4} variants={fadeUp} className="mt-4 text-sm text-muted-foreground">
              No se requiere tarjeta de crédito · Prueba gratis 14 días
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Herramientas de IA diseñadas para equipos que buscan eficiencia, calidad y resultados medibles.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((c, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl ${c.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {plans.map((p, i) => (
              ...
              >
                ...
                <Button
                  className={`w-full ${p.featured ? "btn-primary-gradient" : ""}`}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
            Únete a más de 500 empresas que ya usan convert-IA para convertir ideas en resultados.
          </p>
          <Button size="lg" className="btn-primary-gradient px-10 py-3 text-base" onClick={handleStart}>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Convierte ideas en resultados reales con inteligencia artificial.
              </p>
            </div>
            {[
